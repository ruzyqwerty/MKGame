...
#pragma warning restore IDE0059
        ...
        public void OnReceiveMessage(MessageType type, object msg)
        {
            ...
            else if (type == MessageType.StartSoloGame)
            {
                OnReceiveMessage(MessageType.ConfirmInGameState, null);
                SceneManager.LoadSceneAsync("Scenes/Game");
            }
            ...
            else if (type == MessageType.PlayerSetTeam)
            {
                m_localUser.TeamStates = (TeamStates)msg;
                Debug.Log($"Player: {m_localUser.DisplayName} changed state to {(TeamStates)msg}");
            }
		}
